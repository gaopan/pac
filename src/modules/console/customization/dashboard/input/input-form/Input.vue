                                            ...
                                            <table v-if="f.list" class="leap-table">
                                              ...
                                              <tbody v-if="f.listData && f.listData.length > 0">
                                                <tr v-for="row in f.listData">
                                                  ...
                                                  <td>
                                                    <a href="javascript:void(0)" @click="editRow(field, f, row)"><i class="icon-edit-2"></i></a>
                                                    <a href="javascript:void(0)" @click="removeRow(field, f, row)"><i class="icon-trash-2"></i></a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                                ...
                                                <tr>
                                                  <td :colspan="f.fields.length + 1">
                                                    <div class="table-no-data">暂时还没有数据，点击
                                                      <button type="button" @click="addNewRow(field, f)" class="btn btn-primary">新增</button> 添加数据
                                                    </div>
                                                  </td>
                                                </tr>
                                              </tbody>
