<template>
  <div class="project-view">
    <div v-show="!newProject">
      <div class="tabs-container" v-show="projects&&projects.length>0">
        ...
        <div class="tab-content" v-if="currentProject">
          <task :project="currentProject"></task>
        </div>
      </div>
      <div v-show="!projects||projects.length<1" class="no-data">没有项目，请联系管理员配置项目。</div>
    </div>
    <div v-if="newProject">
