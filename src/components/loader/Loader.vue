<template>
  <div v-if="isLoading" class="component-loader" :style="{'margin-left': -(data.width || 246)/2 + 'px', 'margin-top': -(data.height || 311 + 17)/2 + 'px'}">
    <div class="loader-content">
      <div>
        <svg class="lds-spinner" width="200px" height="200px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style="background: none;">
          <g transform="rotate(0 50 50)">
            <rect x="47" y="24" rx="9.4" ry="4.8" width="6" height="12" fill="#2BA229">
      ...
      <div v-if="isShow" class="content-text">
        请稍等，正在加载 &#8226; &#8226; &#8226;
      </div>
    </div>
  </div>
